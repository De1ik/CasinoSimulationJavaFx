...
public interface Data {
    ...
    void voteNewUser(int setPlayerId, String setCategory, String tableName, String usersId, String category, final Action onSuccess, final Consumer<Exception> onError);
